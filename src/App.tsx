...
//   interface Window {
//     api: {
//       getChats: (offset: number) => Promise<{ id: string; title: string; unreadCount: number }[]>;
//       getMessages: (chatId: string, before?: number) => Promise<{ id: string; sender: string; body: string }[]>;
//     };
//   }
// }
...
const messages = useChatStore(state => state.messages);
  ...
  return (
    ...
    <div className="flex h-[92.9vh] font-sans">
      ...
      {/* Messages */}
      <ChatList loadingMessages={loadingMessages} active={active} messages={messages} messagesEndRef={messagesEndRef} />
